...
pub(crate) const WCL_LOGIN_SAVED_EMAIL_ACCOUNT: &str = "saved-email";
pub(crate) const WCL_LOGIN_SAVED_EMAIL_INDEX_ACCOUNT: &str = "saved-email-index";
pub(crate) const WCL_LOGIN_METADATA_LEGACY_FILE: &str = "wcl-login.json";
